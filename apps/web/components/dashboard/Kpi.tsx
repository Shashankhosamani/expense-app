  ...
  return (
    <Card className="p-4.5 flex flex-col justify-between gap-4">
      <div className="flex items-start justify-between gap-2">
        <span className="text-[10px] font-semibold uppercase tracking-wider text-ink-3 max-w-[104px] leading-[15px]">
          {label}
        </span>
      ...
      <div className="flex flex-col gap-1">
        <span className="text-[26px] font-medium tracking-tight tabular-nums truncate">{value}</span>
