    ...
    <div className="flex flex-col lg:flex-row gap-5.5 items-start">
      <div className="flex-[1.25] flex flex-col gap-5.5 w-full">
        <div className="flex flex-col gap-1.5">
          <h1 className="text-[30px] font-medium tracking-tight">Budget</h1>
          <span className="text-[13px] text-ink-3">Plain arithmetic. Nothing here is guessed.</span>
        </div>
        ...
        <div className="bg-surface-raised border border-border rounded-xl p-6.5 flex flex-col gap-6">
          ...
          <div className="border-t border-dashed border-border-2 pt-5.5 flex flex-col gap-4">
            <div className="flex items-baseline justify-between">
              <span className="text-[13px] text-ink-2">Warn me when I reach</span>
        ...
        <div className="bg-surface-raised border border-border rounded-xl p-6.5 flex flex-col gap-4.5">
          <div className="flex flex-col gap-1">
            <span className="text-xl font-medium">How you hear about it</span>
            <span className="text-xs text-ink-3">Checked every time a new expense is saved.</span>
          </div>
      ...
      <div className="flex-1 w-full flex flex-col gap-5.5 pt-0 lg:pt-15">
